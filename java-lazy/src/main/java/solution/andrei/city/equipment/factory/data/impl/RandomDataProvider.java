...
public class RandomDataProvider implements DataProvider {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < randomDataProvider.generateParameters(EquipmentType.PORTABLE).size(); i++) {
            System.out.println(randomDataProvider.generateParameters(EquipmentType.PORTABLE).get(i));
        }
    }
